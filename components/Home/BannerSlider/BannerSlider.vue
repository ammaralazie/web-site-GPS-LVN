<template>
  <div class="banner-wrap">
    <div class="carousel" v-if="loaded">
      <v-img src="/images/background-gpslvn.gif"  width="100%" height="100%">
                ...
                <v-row>
                  <v-col md="6" cols="12" class="px-sm-6 d-flex align-center">
                    <div class="text">
                      ...
                      <div class="btn-area">
                        <v-btn text large href="#" class="button">
                          {{ $t('common.btn_detail') }}
                        </v-btn>
                        <v-btn large color="secondary" :href="link.saas2.contact" class="button">
                          {{ $t('saas2.getstarted') }}
                          &nbsp;
                        </v-btn>
                      </div>
                  ...
                  <v-col md="6" cols="12" class="px-6">
                    <div class="img">
                      <img class="img-2d3d img-slide1 imgmap" :src="imgAPI.saas2[1]" :data-2d="imgAPI.saas2[0]"
            ...
            <div class="inner">
              ...
              <v-container>
                <v-row justify="end" :class="[isMobile ? 'column-reverse' : 'row']">
                  <v-col md="6" cols="12" class="px-6">
                    <div class="img">
                      <img class="img-2d3d img-slide2" :src="imgAPI.saas2[3]" :data-2d="imgAPI.saas2[2]"
                        :data-3d="imgAPI.saas2[3]" alt="banner 2 3D" />
                    </div>
                  </v-col>
                  <v-col md="6" cols="12" class="px-sm-6 d-flex align-center">
                    <div class="text">
                ...
                <v-row justify="end">
                  ...
                  <v-col cols="12">
                    <div class="img h-banner">
                      <img class="img-2d3d" :src="imgAPI.saas2[7]" :data-2d="imgAPI.saas2[6]" :data-3d="imgAPI.saas2[7]"
                        alt="banner 3 3D" />
                    </div>
                  </v-col>
                </v-row>
    ...
    <div class="slide-nav-group" style="z-index: 10;">
      ...
      <hidden point="smDown">
        <v-container>
          <nav class="slide-nav">
            <v-btn :class="{ active: currentSlide === 0 }" @click="gotoSlide(0)" text class="text-center">
            ...
            <v-btn :class="{ active: currentSlide === 1 }" @click="gotoSlide(1)" text class="text-center">
