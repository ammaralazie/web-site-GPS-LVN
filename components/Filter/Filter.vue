<template>
  <aside class="filter">
    ...
    <div class="filter-block">
      ...
      >
        <v-list-item :value="0">
          <v-list-item-title>All Rating</v-list-item-title>
        </v-list-item>
        <v-list-item :value="1">
          <v-list-item-content>
            <v-list-item-title>
    ...
    <div class="filter-block">
      ...
      <v-text-field class="input-price" outlined hide-details v-model="from" placeholder="$ From" />
      &nbsp; - &nbsp;
      <v-text-field class="input-price" outlined hide-details v-model="to" placeholder="$ To" />
      <v-btn
        color="primary"
        :elevation="0"
        small
        ...
        >
          <v-list-item value="check-a">
            <template #default="{ active }">
              <v-list-item-action>
                <v-checkbox :input-value="active" color="secondary"></v-checkbox>
              </v-list-item-action>
    ...
    <div class="filter-block">
      <v-list>
        ...
        >
          <v-list-item>
            <v-radio :label="$t('common.list_filter')" color="secondary" value="all" />
          </v-list-item>
          <v-list-item>
            <v-radio value="radio-a" color="secondary" label="Radio A" />
          </v-list-item>
          <v-list-item>
            <v-radio value="radio-b" color="secondary" label="Radio B" />
          </v-list-item>
          <v-list-item>
            <v-radio value="radio-c" color="secondary" label="Radio C" />
          </v-list-item>
          <v-list-item>
            <v-radio value="radio-d" color="secondary" label="Radio D" />
          </v-list-item>
          <v-list-item>
            <v-radio value="radio-e" color="secondary" label="Radio E" />
          </v-list-item>
          <v-list-item>
            <v-radio value="radio-f" color="secondary" label="Radio F" />
          </v-list-item>
        </v-radio-group>
      </v-list>
    </div>
