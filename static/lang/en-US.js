  ...
  return new Promise(function(resolve) {
    resolve({
      ...
      saas2: {
        ...
        'slid3-subtitle':"You won't need any specialized tracking system for company vehicles - with GPSLVN smart app, you can keep a close eye on your fleet in a few simple clicks.Manage everything through our user- friendly administrative system - fuel log entries, costs and many other features necessary for the management of your company's vehicles.",
        'Data privacy and security':'Data privacy and security',
        'fleet management':'Fleet Management',
        'slid2-title':'Fleet Management and Scalability Reliability in Challenging Environments in iraq State institutions',
        'slid2-subtitle1':'Integration with Local Infrastructure:',
        'slid2-subtitle':'LVN systems are designed to be low-maintenance, which can be an advantage in areas where infrastructure and support for fleet management technology may be limited.',
        ...
        'slid1-title':'Why GPS LVN Mobile Telematics is the Better Choice for Fleet Management in iraq',
        'slid1-subtitle':'Local Support and Expertise Choosing a GPS LVN mobile telematics provider with local presence and support in Iraq can be valuable for technical assistance, maintenance, and troubleshooting',
        ...
        "driver-engagements":"Driver engagements",
        "details":"The national operator of the national platform for tracking units in Iraq by the Ministry of Communications and licensed by the Communications and Media Commission .",
