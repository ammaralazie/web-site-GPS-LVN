  ...
  return new Promise(function (resolve) {
    resolve({
      ...
      saas2: {
        ...
        'slid3-subtitle': 'لن تحتاج إلى أي نظام تتبع متخصص لمركبات الشركة - مع تطبيق لڤن الذكي، يمكنك مراقبة أسطولك بسهولة بضغطات بسيطة. قم بإدارة كل شيء من خلال نظام الإدارة الخاص بنا والذي يسهل الاستخدام - سجلات سجلات الوقود، التكاليف والعديد من الميزات الأخرى الضرورية لإدارة مركبات شركتك.',
        'Data privacy and security':'خصوصية البيانات وأمنها',
        'fleet management':'إدارة الأسطول',
        'slid2-title':'إدارة الأسطول وقابلية التوسع الموثوقية في البيئات الصعبة في مؤسسات الدولة العراقية',
        'slid2-subtitle1': 'التكامل مع البنية التحتية المحلية:',
        'slid2-subtitle': 'تم تصميم أنظمة لڤن لتكون منخفضة الصيانة، مما يمكن أن يكون ميزة في المناطق التي قد تكون فيها البنية التحتية والدعم لتقنيات إدارة الأسطول محدودة.',
        'Tracking Server':'خادم التتبع',
        'Customization and Scalability':'التخصيص وقابلية التوسع',
        'Personal tracking':'التتبع الشخصي',
        'slid1-subtitle': 'الدعم والخبرة المحلية يمكن أن يكون اختيار مزود خدمات الاتصالات عبر الهاتف المحمول نظام تحديد المواقع لڤن مع التواجد والدعم المحلي في العراق أمرًا ذا قيمة للمساعدة الفنية والصيانة واستكشاف الأخطاء وإصلاحها',
        'slid1-title': 'لماذا يعد نظام تحديد المواقع لڤن المحمول عن بعد الخيار الأفضل لإدارة الأسطول في العراق',
        ...
        "details":"المشغل الوطني للمنصة الوطنية لتتبع الوحدات في العراق من قبل وزارة الاتصالات ومرخص من قبل هيئه الاعلام والاتصالات .",
