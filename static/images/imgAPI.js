const img3d = {
  main: [
    ...
    '',
    '/images/saas2/background_3d@2x.png',
    '',
    '/images/saas2/banner3_3d@2x.png',
    '/images/saas2/banner3_3d@2x.png',
    '',
    '/images/saas2/plant1_3d@2x.png',
    '',
    '/images/saas2/plant2_3d@2x.png',
    '',
    '/images/saas2/plant3_3d@2x.png',
    '',
    '/images/saas2/integration1_3d@2x.png',
    '',
    '/images/saas2/integration2_3d@2x.png'
  ],
  inner: [
    '',
    '/images/saas2/about_3d@2x.png',
    '',
    '/images/saas2/login_3d@2x.png',
    '',
    '/images/saas2/register_3d@2x.png',
    '',
    '/images/saas2/faq_3d@2x.png',
    '',
    '/images/saas2/error_3d@2x.png',
    '',
    '/images/saas2/team_3d@2x.png'
  ]
}
...
const img2d = {
  main: [
    '',
    '/images/saas2/banner1_2d@2x.png',
    '',
    '/images/saas2/banner2_2d@2x.png',
    '',
    '/images/saas2/background_2d@2x.png',
    '',
    '/images/saas2/banner3_2d@2x.png',
    '',
    '',
    '/images/saas2/plant1_2d@2x.png',
    '',
    '/images/saas2/plant2_2d@2x.png',
    '',
    '/images/saas2/plant3_2d@2x.png',
    '',
    '/images/saas2/integration1_2d@2x.png',
    '',
    '/images/saas2/integration2_2d@2x.png'
  ],
  inner: [
    '',
    '/images/saas2/about_2d@2x.png',
    '',
    '/images/saas2/login_2d@2x.png',
    '',
    '/images/saas2/register_2d@2x.png',
    '',
    '/images/saas2/faq_2d@2x.png',
    '',
    '/images/saas2/error_2d@2x.png',
    '',
    '/images/saas2/team_2d@2x.png'
  ]
}
...
const imgAPI = {
  ...
  ui: [
    '/images/saas2/menu_pos@2x.jpg',
    '/images/saas2/menu_education@2x.jpg',
    '/images/saas2/menu_saas2@2x.jpg',
    '/images/saas2/menu_marketing@2x.jpg',
    '/images/saas2/team_2d@2x.png',
    '/images/saas2/team_3d@2x.png',
    '/images/saas2/menu_agency@2x.jpg',
    '/images/saas2/menu_cloud@2x.jpg',
    '/images/saas2/menu_crypto@2x.jpg',
    '/images/saas2/menu_education@2x.jpg',
    '/images/saas2/menu_finance@2x.jpg',
    '/images/saas2/menu_marketing@2x.jpg',
    '/images/saas2/menu_medical@2x.jpg',
    '/images/saas2/menu_pos@2x.jpg',
    '/images/saas2/menu_saas@2x.jpg',
    '/images/saas2/menu_saas2@2x.jpg',
    '/images/saas2/menu_social@2x.jpg',
    '/images/saas2/menu_other@2x.jpg'
  ],
  saas2: [
    ...img3d.main,
